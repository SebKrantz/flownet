...
While `consolidate_graph()` simplifies the network topography preserving full connectivity, the `simplify_network()` function provides two methods for further reducing network complexity while preserving connectivity between important nodes:
