...
- **[`run_assignment()`](https://sebkrantz.github.io/flownet/dev/reference/run_assignment.md)**:
  ...
  - Configurable detour factors and angle constraints for route
    selection
  - Optional return of detailed path information, edge counts, costs,
    and weights
...
- **[`simplify_network()`](https://sebkrantz.github.io/flownet/dev/reference/simplify_network.md)**:
  ...
  - **Method “cluster”**: Spatially clusters nodes using `leaderCluster`
