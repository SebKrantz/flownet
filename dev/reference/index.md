...
- [`flownet-package`](https://sebkrantz.github.io/flownet/dev/reference/flownet-package.md)
  [`flownet`](https://sebkrantz.github.io/flownet/dev/reference/flownet-package.md)
...
- [`linestrings_to_graph()`](https://sebkrantz.github.io/flownet/dev/reference/linestrings_to_graph.md)
...
- [`consolidate_graph()`](https://sebkrantz.github.io/flownet/dev/reference/consolidate_graph.md)
  : Consolidate Graph
...
- [`run_assignment()`](https://sebkrantz.github.io/flownet/dev/reference/run_assignment.md)
  [`print(`*`<flownet>`*`)`](https://sebkrantz.github.io/flownet/dev/reference/run_assignment.md)
...
- [`normalize_graph()`](https://sebkrantz.github.io/flownet/dev/reference/normalize_graph.md)
  : Normalize Graph Node IDs
- [`nodes_from_graph()`](https://sebkrantz.github.io/flownet/dev/reference/nodes_from_graph.md)
  : Extract Nodes from Graph
- [`linestrings_from_graph()`](https://sebkrantz.github.io/flownet/dev/reference/linestrings_from_graph.md)
  : Convert Graph to Linestrings
- [`distances_from_graph()`](https://sebkrantz.github.io/flownet/dev/reference/distances_from_graph.md)
...
- [`melt_od_matrix()`](https://sebkrantz.github.io/flownet/dev/reference/melt_od_matrix.md)
...
- [`africa_cities_ports`](https://sebkrantz.github.io/flownet/dev/reference/africa_cities_ports.md)
  : African Cities and International Ports
- [`africa_network`](https://sebkrantz.github.io/flownet/dev/reference/africa_network.md)
  : Trans-African Road Transport Network
- [`africa_segments`](https://sebkrantz.github.io/flownet/dev/reference/africa_segments.md)
  : Raw Network Segments for Trans-African Transport Network
- [`africa_trade`](https://sebkrantz.github.io/flownet/dev/reference/africa_trade.md)
